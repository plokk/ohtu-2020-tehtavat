...
public class Stepdefs {
    ...
    public void validUsernameAndPasswordAndMatchingPasswordAreEntered(String username, String password) {
    ...
    public void tooShortUsernameAndValidPasswordAndMatchingPasswordAreEntered(String username, String password) {
        newUserWith(username, password, password);
    }

    @When("a valid username {string} and too short password {string} and matching password confirmation are entered")
    public void validUsernameAndTooShortPasswordAndMatchingPasswordAreEntered(String username, String password) {
        newUserWith(username, password, password);
    }

    @When("a valid username {string} and valid non-matching password {string} and password confirmation {string} are given")
    public void nonMatchingPasswordAndConfirmation(String username, String password, String passwordConfirmation) {
    ...
    public void userIsNotCreatedAndErrorIsReported2() {
        pageHasContent("password should have at least 8 characters");
    }

    @Then("user is not created and error \"password and password confirmation do not match\" is reported")
    public void userIsNotCreatedAndErrorIsReported3() {
